...
func getTemplatePaths(resourceConfigType *discover.ApplicationResourceConfigType) ([]string, error) {
	...
	supportedResourceTypes := []discover.ApplicationResourceType{
		...
		discover.ApplicationResourceTypeCloudConsole,
		...
		discover.ApplicationResourceTypeDatabaseApplications,
	...
	resourceTypeToPath := map[discover.ApplicationResourceType]string{
		...
		discover.ApplicationResourceTypeCloudConsole:                 "cloudconsole",
		...
		discover.ApplicationResourceTypeDatabaseApplications:         "databaseapplications",
