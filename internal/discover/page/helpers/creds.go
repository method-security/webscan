...
var TokenFingerprints = discover.TokenFingerprints{
	Fingerprints: []*discover.TokenFingerprint{
		...
		{Type: "figma_token", Pattern: `\b(fig[d|((u|o)(r|h)?)]_[a-z0-9A-Z_-]{40})\b`, Confidence: discover.TokenConfidenceLevelHigh},
		...
		{Type: "grafana_service_token", Pattern: `\b(glsa_[0-9a-zA-Z_]{41})\b`, Confidence: discover.TokenConfidenceLevelHigh},
		...
		{Type: "openai_api_key", Pattern: `\b(sk-[a-zA-Z0-9]{48})\b`, Confidence: discover.TokenConfidenceLevelHigh},
		{Type: "sendgrid_key", Pattern: `(SG\.[0-9A-Za-z\-_]{22}\.[0-9A-Za-z\-_]{43})`, Confidence: discover.TokenConfidenceLevelHigh},
		{Type: "shopify_token", Pattern: `\b(shp[a-z]{2}_[a-fA-F0-9]{32})\b`, Confidence: discover.TokenConfidenceLevelHigh},
		{Type: "square_token", Pattern: `\b(sq0idp-[0-9A-Za-z]{22})\b`, Confidence: discover.TokenConfidenceLevelHigh},
		{Type: "stripe_key", Pattern: `(sk_live_[0-9a-zA-Z]{24}|pk_live_[0-9a-zA-Z]{24})`, Confidence: discover.TokenConfidenceLevelHigh},
		{Type: "twilio_api_key", Pattern: `\b(SK[0-9a-f]{32})\b`, Confidence: discover.TokenConfidenceLevelHigh},
