...
RUN \
  ...
  mkdir -p /opt/method/${CLI_NAME}/var/conf/pentest/dast && \
  mkdir -p /opt/method/${CLI_NAME}/var/conf/pentest/dast/path && \
  mkdir -p /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/general && \
  mkdir -p /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/technologies && \
  mkdir -p /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/technologies/cms && \
  mkdir -p /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/technologies/webserver && \
...
COPY configs/pentest/dast/*                                 /opt/method/${CLI_NAME}/var/conf/pentest/dast/
COPY configs/pentest/dast/path/*                            /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/
COPY configs/pentest/dast/path/general/*                    /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/general/
COPY configs/pentest/dast/path/technologies/*               /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/technologies/
COPY configs/pentest/dast/path/technologies/cms/*           /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/technologies/cms/
COPY configs/pentest/dast/path/technologies/webserver/*     /opt/method/${CLI_NAME}/var/conf/pentest/dast/path/technologies/webserver/
