...
func PerformAppEnumerateGrpc(ctx context.Context, target string) enumerateapiapplicationfern.RoutesReport {
	report := enumerateapiapplicationfern.RoutesReport{Target: target, BaseEndpointUrl: target, AppType: enumerateapiapplicationfern.ApiTypeGrpc}
...
func processServices(stream grpc_reflection_v1alpha.ServerReflection_ServerReflectionInfoClient, services []*grpc_reflection_v1alpha.ServiceResponse, report *enumerateapiapplicationfern.RoutesReport) ([]*descriptorpb.FileDescriptorProto, error) {
...
func unmarshalFileDescriptors(fileDescriptorBytes [][]byte, rawDescriptors *[]*descriptorpb.FileDescriptorProto, report *enumerateapiapplicationfern.RoutesReport) error {
...
func extractMethods(fileDesc *descriptorpb.FileDescriptorProto, report *enumerateapiapplicationfern.RoutesReport) {
	for _, service := range fileDesc.Service {
		for _, method := range service.Method {
			...
			route := enumerateapiapplicationfern.Route{
				...
				Type:        enumerateapiapplicationfern.ApiTypeGrpc,
...
func encodeRawDescriptors(rawDescriptors []*descriptorpb.FileDescriptorProto, report *enumerateapiapplicationfern.RoutesReport) error {
