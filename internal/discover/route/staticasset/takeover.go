...
func createSendHTTPRequestConfig(targetBaseURL, targetPath string, config discoverroutefern.StaticAssetTakeoverConfig, browserbaseSecrets *common.BrowserbaseRequestSecrets) common.SendHttpRequestConfig {
...
func isStaticAssetTakeOver(httpRequestResponse *common.HttpRequestResponse, fingerprints []*discoverroutefern.StaticAssetTakeoverFingerprint, successfulOnly bool) []*discoverroutefern.StaticAssetTakeoverVulnerableDetails {
	info := []*discoverroutefern.StaticAssetTakeoverVulnerableDetails{}
	...
	for _, fingerprint := range fingerprints {
		instance := discoverroutefern.StaticAssetTakeoverVulnerableDetails{
